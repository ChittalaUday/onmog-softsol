...
import { getCareerBySlug, JOB_TYPE_LABELS, type CmsJob } from "@/lib/cms";
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${job.title} — Onmog Softsol Careers`,
      ...
      <section style={{ position: "relative", overflow: "hidden", padding: "150px 24px 60px" }}>
        ...
        <div style={{ position: "relative", maxWidth: 860, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginTop: 22 }}>
            ...
            {job.requiredExperience && <Chip icon={<ClockIcon />}>{job.requiredExperience}</Chip>}
